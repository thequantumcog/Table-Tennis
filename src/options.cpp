...
void options(State &gameState){
    ...
    if(!onSpeed) cycleOptions(2,cps);
    if(cps == 0)
        DrawTexture(selector,screenWidth / 2.0f - 190.0f, screenHeight / 2.0f + 30.0f,WHITE);
    else if (cps == 1)
        DrawTexture(selector,screenWidth / 2.0f , screenHeight / 2.0f +30.0f,WHITE);
